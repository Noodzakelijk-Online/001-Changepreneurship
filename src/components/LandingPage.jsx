        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              {isAuthenticated && (
                <Link to="/user-dashboard" className="text-sm font-medium hover:text-primary transition-colors">
                  Dashboard
                </Link>
              )}
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Comprehensive Knowledge Base</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Access proven frameworks, step-by-step processes, and visual diagrams from leading entrepreneurship experts. 
              Learn at your own pace with structured learning paths designed for every experience level.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Strategic frameworks from industry leaders like Lean Startup, Business Model Canvas, and more
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>22+ Frameworks</span>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Step-by-step processes for customer development, market validation, and business development
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>21+ Processes</span>
                  <Badge variant="secondary">Interactive Steps</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Structured learning journeys that guide you from beginner to expert entrepreneur
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-muted-foreground">Knowledge Resources</div>
            </div>
            <div>
